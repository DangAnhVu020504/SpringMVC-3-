            ...
            <div class="col-md-6 mt-0">
                ...
                <% User user = (User) request.getAttribute("user"); %>
                    <div class="card-body">
                        ...
                        <button href="${pageContext.request.contextPath}/edit" class="btn btn-primary mb-3">Chỉnh sửa hồ sơ</button>
                ...
                <div class="card p-3 mb-3">
                    ...
                    <p><%= post.getTitle() %></p>
                    <p><%= post.getBody() %></p>
                    <a href="${pageContext.request.contextPath}/edit" class="btn btn-primary mb-3">Chỉnh sửa hồ sơ</a>
